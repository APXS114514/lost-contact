...
window.STORY = {
  ...
  xhs: {
    posts: [
      {title:"25岁装修100㎡小家，普通却温馨", body:"坐标山东，套内93平，三室两厅。自己设计的家，没有找装修公司。温馨自由舒服，无论多晚回家，都有一盏灯为自己点亮，就足够啦。", imgs:["xhs/xhs7.webp","xhs/xhs8.webp"], author:"惠宝儿", avatar:"xhs/xhs2.webp", likes:18000, cat:"装修", tags:["装修日记","家居美学"], date:"2026-07-02"},
      {title:"短发扎着还是披着，怎么好看怎么来！", body:"短发妹妹的日常造型分享，随手一扎就很清爽，不同场合不同风格，总有一款适合你。", imgs:["xhs/xhs15_png.webp"], author:"无敌桃桃", avatar:"桃", likes:3627, cat:"时尚", tags:["短发","日常造型"], date:"2026-07-05"},
  ...
  stage3: {
    letterName: "求救信.txt",
    letter: "给 AP：\n\n如果你看到这个文件，说明你已经把所有东西都看完了。\n\n文三路515。她在那。\n报警的时候，把坐标一起报上去。\n别信任何上线的号。包括我的。\n\n—— 铭泽",
    terminal: {
      sosOut: "求救信号已发送……\n坐标：N30.283, E120.133（≈ 文三路515一带）\n\n电脑开始发热。屏幕上的字，慢慢变淡了。",
      goto515Out: "正在前往：杭州市西湖区文三路515号\n距离 0 m。\n\n这行字出现的一瞬间，电脑自己黑屏了。",
      help3: "可用指令：help / clear / whoami / date / ls / cat <文件> / 报警 [坐标] / shutdown"
    }
  }
};